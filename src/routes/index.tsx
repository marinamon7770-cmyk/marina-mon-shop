...
const COLLECTIONS = [
  { slug: "bags", title: "Сумки", key: "home_collection_bags", img: bagsImg, sub: "плетёное + натуральная кожа" },
  { slug: "storage", title: "Короба и системы хранения", key: "home_collection_storage", img: storageImg, sub: "для дома и порядка" },
  { slug: "baskets", title: "Корзины и подносы", key: "home_collection_baskets", img: basketsImg, sub: "для дома, дачи и подарков" },
  { slug: "leather", title: "Кожаные вещи", key: "home_collection_leather", img: leatherImg, sub: "из натуральной кожи" },
];
    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 lg:grid-cols-12 lg:gap-16 lg:px-10 lg:py-28">
          <div className="lg:col-span-6 lg:pt-12">
            <p className="tag-label">плетёные вещи и кожа · Тольятти</p>
            <h1 className="font-display mt-8 text-5xl leading-[1.05] sm:text-6xl lg:text-7xl">
              Короба, корзины
              <br />
              и сумки,
              <br />
              <span className="italic text-primary">которым легко</span>
              <br />
              найти место
              <br />
              в жизни.
          ...
          <div className="relative lg:col-span-6">
            ...
            <div className="absolute -bottom-6 -left-6 hidden bg-background p-6 shadow-[var(--shadow-warm)] sm:block lg:-left-12">
              <div className="font-display text-3xl italic text-primary">Не «почти подходит».<br />Подходит.</div>
              <div className="mt-2 text-xs uppercase tracking-[0.22em] text-muted-foreground">
                короба и корзины по размерам вашего дома
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-y border-border/60 bg-[var(--sand)]/40">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-20 md:grid-cols-3 lg:px-10">
          {[
            { n: "01", t: "По вашим размерам", d: "Под полку, шкаф, ящик или нишу — чтобы короб не был «почти подходящим»." },
            { n: "02", t: "Оттенок под интерьер", d: "Подберём цвет к мебели, стенам или текстилю, чтобы вещь спокойно вошла в дом." },
            { n: "03", t: "Ручная работа", d: "Каждое изделие плету, прошиваю и собираю сама — от основы до последней детали." },
          ].map((b) => (
            <div key={b.n}>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        <div className="flex items-end justify-between gap-6">
          <div>
            ...
            <h2 className="font-display mt-6 text-4xl sm:text-5xl">Что можно заказать</h2>
          </div>
          <Link
            to="/catalog"
      ...
      {featured.data && featured.data.length > 0 && (
        <section className="border-t border-border/60 bg-[var(--linen)]">
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
            <p className="tag-label">в наличии</p>
            <h2 className="font-display mt-6 text-4xl sm:text-5xl">Готовые изделия</h2>
      ...
      <section className="mx-auto max-w-4xl px-6 py-28 text-center lg:px-10">
        ...
        <blockquote className="font-display mt-10 text-3xl italic leading-snug sm:text-4xl">
          У вас уже есть место для короба.<br />
          Остаётся сделать короб, который туда встанет.
        </blockquote>
      ...
      {/* Question form */}
      <section id="contact" className="border-t border-border/60 bg-[var(--sand)]/40 scroll-mt-24">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-24 lg:grid-cols-2 lg:px-10">
          <div>
            <p className="tag-label">заказ и вопросы</p>
            <h2 className="font-display mt-6 text-4xl sm:text-5xl">
              Нужен короб
              <br />
              <span className="italic text-primary">по размеру?</span>
              <br />
              Давайте обсудим.
            </h2>
            <p className="mt-6 max-w-md text-muted-foreground">
              Напишите размеры, пришлите фото места или просто расскажите, для чего нужна вещь.
              Я подскажу, что можно сделать, и сориентирую по стоимости и срокам.
            </p>
          </div>
          <div>
            <QuestionForm />
